...
->group(function () {
    ...
    Route::delete('/delete/{id}', [OrderMedicineController::class, 'destroy'])
    ->name('ordermedicine.delete');    Route::get('/dispense_medication/{id}', [OrderMedicineController::class, 'dispenseMedication'])->name('ordermedicine.dispense');
});
