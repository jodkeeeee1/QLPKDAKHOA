...
Route::get('/updateStatus/{id}', [OrderProductController::class, 'updateStatus'])
    ->name('orderproduct.updateStatus');
 ...
 Route::get('/print/{id}', [OrderProductController::class, 'print'])
    ->name('orderproduct.print');
    Route::delete('/delete/{id}', [OrderProductController::class, 'delete'])
