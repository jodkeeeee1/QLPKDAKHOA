...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb__text">
                        <img src="{{ asset('frontend/shop/img/banner/bn.png') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    {{-- Icon xem chi tiết --}}
    <li>
        <a href="{{ route('shop.shop-details', $productsActiveItem->product_id) }}">
            <i class="fa fa-eye"></i>
        </a>
    </li>
    ...
    <li>
        <form
            ...
            <button type="submit"
                class="btn-add-to-cart border-0 bg-transparent">
