...
@section('meta_title', 'Phòng Khám Đa Khoa Nhật Minh')

@section('content')

    <!-- <div class="main-body">
        <div class="section box box-head">
            <img src="{{asset('frontend/assets/image/1.png')}}" alt="Background"/>
                                    ...
                                    <div class="about__head--content">
                                        <div class="content-detail">
                                            <p>
                                                ...
                                                Phòng Khám Đa Khoa Nhật Minh đã và đang liên tục hoàn thiện
        ...
        <div class="container">
            <div class="row align-items-center" style="height: 90vh;">
                <div class="col-md-5 d-flex justify-content-center align-items-center">
                    <img src="{{asset('frontend/assets/image/l.jpg')}}" alt="Logo" class="logo-inproduce">
                </div>
                <div class="col-md-7">
                    <h2 class="text-success">Sứ mệnh</h2>
                    <p>Phòng Khám Đa Khoa Nhật Minh cam kết mang lại dịch vụ y tế chất lượng cao, an toàn và hiệu quả nhất
        ...
        <div class="container">
            <div class="d-flex col-md-12" style="height: 90vh;">
                <div class="col-md-6 p-5">
                    <h2 class="text-success">Giá trị cốt lõi</h2>
                    ...
                    <p>Đội ngũ bác sĩ và nhân viên của Phòng Khám Đa Khoa Nhật Minh luôn tận tâm và chu đáo trong mọi quá
