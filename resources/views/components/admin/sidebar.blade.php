            ...
            <div>
                <div class="brand-logo d-flex align-items-center justify-content-between">
                    <a href="{{ route('system.dashboard') }}" class="text-nowrap logo-img ms-5">
                        <img src="{{ asset('backend/assets/images/logos/NhatMinh.png') }}" width="120" alt="" />
                    </a>
                ...
                <nav class="sidebar-nav scroll-sidebar " data-simplebar="">
                    <ul id="sidebarnav">
                        ...
                        <!-- <li
                            class="sidebar-item {{ request()->is('system/schedules*') || request()->is('system/schedules?*') ? 'selected' : '' }}">
                            <a class="sidebar-link" href="{{ route('system.schedules.index') }}" aria-expanded="false">
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round"
            ...
            <div>
                <div class="brand-logo d-flex align-items-center justify-content-between">
                    <a href="#" class="text-nowrap logo-img ms-5">
                        <img src="{{ asset('backend/assets/images/logos/NhatMinh.png') }}" width="120"
                            alt="" />
                    </a>
                    <div class="close-btn d-xl-none d-block sidebartoggler cursor-pointer" id="sidebarCollapse">
                        <i class="ti ti-x fs-8"></i>
