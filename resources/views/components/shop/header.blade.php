...
<div class="humberger__menu__wrapper">
    <div class="humberger__menu__logo">
        <a href="#"><img src="{{ asset('frontend/shop/img/Nhật Minh.png')}}" alt=""></a>
    </div>
            ...
            <div class="col-lg-3">
                <div class="header__logo">
                    <a href="{{ route('client.home') }}">
                        <img src="{{ asset('frontend/shop/img/Nhật Minh.png') }}" style="max-height: 50px"
                            alt=""></a>
                </div>
            </div>
            <div class="col-lg-6">
    ...
    <a href="{{ url('/') }}">Trang chủ</a>
            ...
            <div class="col-lg-3 d-flex justify-content-end">
                <div class="header__cart d-flex align-items-center justify-content-end gap-3">
                 @if (auth()->check())
<div class="header__login position-relative"
     onclick="toggleMenu()"
     style="cursor: pointer; border: 1px solid #048647;">
    ...
    @php
        ...
        if (!empty($avatar)) {
            // Nếu avatar là URL (Google/Facebook/Zalo...)
            if (filter_var($avatar, FILTER_VALIDATE_URL)) {
                $avatarUrl = $avatar;
            } 
            // Nếu là ảnh upload trong hệ thống
            else {
                $avatarUrl = asset('storage/uploads/avatars/' . $avatar);
            }
        }
    @endphp

    <img
        class="border-success w-auto"
        style="width:32px !important; height:32px !important; cursor:pointer;"
        src="{{ $avatarUrl }}"
...
<div class="dropdown">
    <button class="btn btn-sm btn-primary dropdown-toggle"
            type="button"
            id="dropdownLoggedOutButton">
        Đăng nhập
    </button>

    <div id="dropdownMenuLoggedOut"
...
@foreach ($parent_categories as $parent_categories_item)
    <li>
    <a href="{{ url('/cua-hang') }}?parent_id={{ $parent_categories_item->parent_id }}">
    {{ $parent_categories_item->name }}
</a>
    </li>
@endforeach
</ul>
