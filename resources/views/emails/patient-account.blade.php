...
<head>
    ...
    <title>Thông tin tài khoản bệnh nhân nhân</title>
    <!-- Bootstrap 5 CSS -->
    ...
    <div class="container my-5">
        <div class="card shadow-sm">
            <div class="card-body p-4" style="width: 100%; max-width: 800px; margin: 0 auto;">
                ...
                <p>Chúc mừng bạn đã đăng ký tài khoản bệnh nhân thành công tại Nhật Minh. Dưới đây là thông tin tài khoản của bạn:</p>
                ...
                <p>Xin cảm ơn bạn đã tin tưởng và lựa chọn Nhật Minh.</p>

                <p>Trân trọng,</p>
                <p>Đội ngũ Nhật Minh</p>
