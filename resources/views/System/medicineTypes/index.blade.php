                    ...
                    @foreach ($medicineType as $data)
                        <tr class="text-center">
                            ...
                            <td class="border-bottom-0 d-flex justify-content-center align-items-center">
                               ...
                               <form action="{{ route('system.medicineTypes.delete', $data->medicine_type_id) }}"
    id="form-delete{{ $data->medicine_type_id }}"
    method="POST"
...
<script>
    ...
    function openEditModal(id) {
        $.ajax({
            url: '/admin/medicineTypes/edit/' + id,
            type: 'GET',
            success: function (response) {
    ...
    $('#updateMedicineTypeForm').on('submit', function (e) {
        ...
        $.ajax({
            url: '/admin/medicineTypes/update/' + id,
            type: 'PATCH',
            data: {
                // medicine_type_id: id,
                name: $('#nametype').val(),
