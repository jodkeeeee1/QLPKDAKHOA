<div class="table-responsive">
    ...
    <h6 class="fw-semibold mb-0">STT khám</h6>
</th>
                <th class="border-bottom-0">
    ...
    <h6 class="fw-semibold mb-0">{{ $item->stt }}</h6>
</td>
                <td class="border-bottom-0">
 ...
 <li>
    ...
    {{ Carbon\Carbon::parse($item->hour)->format('A') == 'AM' ? 'SA' : 'CH' }}
</li>                                        <li><strong>Ngày khám:</strong>
