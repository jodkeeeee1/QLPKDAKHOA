                ...
                <tbody id="myTable">
                    ...
                    <tr class="text-center">
                        ...
                        <td class="border-bottom-0">
                            ...
                            @endif
                               {{-- Form xóa --}}
    <form action="{{ route('system.delete_sclinic', $sclinic->sclinic_id) }}"
        id="form-delete{{ $sclinic->sclinic_id }}"
        method="POST"
   ...
   function openModalEdit(id) {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            $('#statusSclinicEdit').prop(
                'checked',
                response.statusSclinic == 1
            );

            // lưu id
            $('#exampleModalEdit').data('id', id);

            // load chuyên khoa + selected
