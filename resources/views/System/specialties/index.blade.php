...
var modal = new bootstrap.Modal(document.getElementById('exampleModalEdit'));
modal.show();            console.log(id);
            $.ajax({
                url: '/admin/specialties/edit/' + id,
                type: 'GET',
                success: function(response) {
        ...
        $('#updateSpecialty').click(function() {
            ...
            $.ajax({
                url: '/admin/specialties/update/' + id,
                type: 'PATCH',
                data: {
