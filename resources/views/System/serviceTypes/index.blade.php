                    ...
                    if (deleteButton && !deleteButton.classList.contains('multiple-delete')) {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                const deleteUrl = '/admin/serviceTypes/delete/' + rowId + '/' + directoryId;
            ...
            <script>
                $(document).ready(function() {
                    ...
                    $('.edit-btn').on('click', function() {
                        ...
                        $.ajax({
                            url: '/admin/serviceTypes/edit/' + id, // URL lấy thông tin chỉnh sửa
                            type: 'GET',
                            success: function(response) {
                                ...
                                if (response && response.success && response.servicetype) {
                                    ...
                                    $('#editForm').attr('action', '/admin/serviceTypes/update/' +
