    ...
    <nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
            <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button"
                role="tab" aria-controls="nav-home" aria-selected="true">Lịch khám</button>
    ...
    <form action="{{ route('system.checkupHealth') }}" method="GET" class="row g-2 py-3">
        <div class="col-md-8">
            <div class="row g-2">
                ...
                <div class="col-md-4 col-12">
                    <input type="text" id="phoneInput" class="form-control" placeholder="Số điện thoại" name="phone"
                        value="{{ request('phone') }}">
                </div>
            </div>
        </div>
