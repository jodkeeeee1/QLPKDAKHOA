            ...
            <div class="col-md-4 col-lg-3">
                <div class=" w-100">
                    ...
                    <div class="card-body px-3">
                        <p class="m-1">Bệnh viện Đa Khoa Nhật Minh</p>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    window.addSelectService = function () {

        let select = document.getElementById('myAjaxSelectService');
        ...
        // check trùng
        if (window.selectedServices.find(x => x.id === id)) {
            alert("Dịch vụ đã được chọn!");
            return;
        }

        window.selectedServices.push({ id, name, price });
    ...
    function renderTable() {
        ...
        let tbody = document.querySelector("#selectedTestsTable tbody");
        tbody.innerHTML = "";

        let total = 0;

        window.selectedServices.forEach((item, index) => {
                ...
                <tr>
                    ...
                    <td>
                        <button type="button"
                                ...
                                style="border:none;background:none;color:red;font-size:18px">
                            ❌
                        </button>
                    </td>
                </tr>
        ...
        document.getElementById("selectService").value =
            JSON.stringify(window.selectedServices);
