...
<div class="card w-100">
    ...
    href="#details{{ $doctor->user_id }}"
    role="button"
    aria-expanded="false"
    aria-controls="details{{ $doctor->user_id }}">
    Chi tiết
</a>

<form action="{{ route('system.doctor.destroy', $doctor->user_id) }}"
    method="POST"
    class="delete-form">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        if (doctorId) {
            let formAction = "/admin/doctors/update/" + doctorId;
