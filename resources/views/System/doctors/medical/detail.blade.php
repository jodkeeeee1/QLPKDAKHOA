                    ...
                    <div class="footer-info mt-3 text-center">
                        ...
                        <div class="info">
                            <div class="phone">
                                ...
                                </span>{{ $medical[0]->patient_phone }}
                            </div>
                            <div class="birthday">
                                <span>
                                    <i class="ti ti-calendar"></i>
                                </span> {{ \Carbon\Carbon::parse($medical[0]->patient_birthday)->format('d-m-Y') }}
                            </div>
                            <div class="address">
                                <span>
                                    <i class="ti ti-map-pin"></i>
                                </span> {{ $medical[0]->patient_address }}
                            </div>
                        </div>
                        ...
                        <div class="table-responsive ms-3">
                            ...
                            <div class="col-md-12 row">
                                <div class="col-md-6">
                                    <div class="mb-3 d-flex">
                                        ...
                                        <p>{{ \Carbon\Carbon::parse($medical[0]->patient_birthday)->format('d-m-Y') }}
                                        </p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="col-md-12 row">
                                <div class="mb-3 d-flex">
                                    ...
                                    <p>{{ $medical[0]->doctor_lastname }}
{{ $medical[0]->doctor_firstname }}</p>
                                </div>
                            </div>
                        </div>
