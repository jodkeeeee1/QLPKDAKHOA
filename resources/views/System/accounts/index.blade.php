...
<nav class="mb-3">
    <div class="nav nav-tabs" id="nav-tab" role="tablist">
        ...
        <button class="nav-link {{ $activeTab == 'nav-doctor' ? 'active' : '' }}" id="nav-doctor-tab" data-bs-toggle="tab"
            data-bs-target="#nav-doctor" type="button" role="tab" aria-controls="nav-doctor" aria-selected="true"
            onclick="window.location='?tab=nav-doctor'">Bác sĩ
        </button>
...
<div class="tab-content" id="nav-tabContent">
 ...
 <div class="tab-pane fade show {{ $activeTab == 'nav-doctor' ? 'show active' : '' }}" id="nav-doctor" role="tabpanel"
        aria-labelledby="nav-doctor-tab">
        @include('System.accounts.doctor', ['doctor' => $doctor]) <!-- Truyền biến doctor vào view -->
    </div>
    ...
    <div class="tab-pane fade {{ $activeTab == 'nav-staff' ? 'show active' : '' }}" id="nav-staff" role="tabpanel"
        ...
        @include('System.accounts.staff', ['staff' => $staff]) <!-- Truyền biến staff vào view -->
    </div>
