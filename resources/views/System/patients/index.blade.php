...
@section('content')
                                    ...
                                    <td class="border-bottom-0 d-flex justify-content-center align-items-center">
                                        ...
                                        <a href="javascript:void(0)" class="btn btn-success ms-1"
                                            onclick="openAddModal('{{ $item->patient_id }}')"><i
                                              ...
                                              <form action="{{ route('system.patients.destroy', $item->patient_id) }}"
    method="POST"
    ...
    <script>
        ...
        function openAddModal(id) {
            ...
            $.ajax({
                url: `/admin/patients/addMedical/` + id,
                type: 'GET',
                success: function(response) {
                    ...
                    specialtySelect.on('change', function() {
                        ...
                        if (specialtyId) {
                            $.ajax({
                                url: '/admin/patients/getDoctor/' + specialtyId,
                                type: 'GET',
                                success: function(response) {
    ...
    shiftSelect.append(
        ...
        'Bs. ' + item.lastname + ' ' + item.firstname +
        '</option>'
    );
});
        ...
        $('#addMedicalForm').on('submit', function(e) {
            ...
            $.ajax({
                url: '/admin/patients/saveMedical', // Đảm bảo đường dẫn này chính xác
                type: 'POST',
                data: formData,
                contentType: false,
                processData: false,
