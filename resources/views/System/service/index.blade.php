        ...
        <script>
            $(document).ready(function() {
                ...
                $('#category-select').select2({
                    ...
                    ajax: {
                        url: '/admin/services/listservice',
                        type: 'get',
                        dataType: 'json',
                        delay: 250,
                ...
                $('.edit-btn').on('click', function() {
                    ...
                    $.ajax({
                        url: '/admin/services/edit/' + id, // URL lấy thông tin dịch vụ
                        type: 'GET',
                ...
                $('#editForm').on('submit', function(event) {
                    ...
                    $(this).attr('action', '/admin/services/update/' + serviceId);
                ...
                if (deleteButton && !deleteButton.classList.contains('multiple-delete')) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            const deleteUrl = '/admin/services/delete/' + rowId;
