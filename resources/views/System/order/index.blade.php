                    ...
                    <div class="modal-header">
                        <div class="d-flex flex-row align-items-center">
                            ...
                            <div class="ms-3">
                                ...
                                <p class="mb-0"><strong>SĐT: </strong> 0978.658.099</p>
                            </div>
                        </div>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('.payment-button').on('click', function() {
                    ...
                    $.ajax({
                        url: '/admin/order-services/edit/' + orderId,
                        type: 'GET',
                        dataType: 'json',
                        success: function(response) {
                            ...
                            $('#totalAmount').text(
    new Intl.NumberFormat('vi-VN').format(data.total_price) + ' VND'
);
