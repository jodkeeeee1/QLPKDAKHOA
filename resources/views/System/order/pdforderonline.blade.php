    ...
    <div class="invoice-container">
        <div class="header">
            <div class="header-left">
                {{-- <img src="{{ asset('backend/assets/images/logos/NhatMinh.png') }}" alt="Logo"> --}}
                <p>Bệnh viện Đa Khoa Nhật Minh</p>
                <p>Địa chỉ: 54 Đản Dị - Uy Nỗ - Đông Anh - Hà Nội</p>
                <p>SDT: 0978.658.099</p>
            </div>
        </div>
       ...
       <div class="subtitle">
    @if($orders)
        {{ \Carbon\Carbon::parse($orders->created_at)->format('H:i:s d/m/Y') }}
    @else
