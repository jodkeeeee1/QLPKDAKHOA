...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="{{ asset('backend/assets/images/logos/NhatMinh.png') }}" />


    <link rel="stylesheet" href="{{ asset('backend/assets/libs/simplebar/dist/simplebar.css') }}" />
    <link rel="stylesheet" href="{{ asset('backend/assets/css/icons/tabler-icons/tabler-icons.css') }}" />
    <link rel="stylesheet" href="{{ env('APP_MAIN') }}admin/styles.min.css" />
...
<body>
    ...
    <script src="{{ asset('frontend/library/vendor/cart.js') }}"></script>
