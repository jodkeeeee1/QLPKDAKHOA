...
<head>
    ...
    <link rel="stylesheet" href="{{ env('APP_MAIN') }}clients/style.css" />
    ...
    <title>Nhà thuốc Nhật Minh</title>
...
<body>
    ...
    <script src="{{ asset('frontend/library/vendor/boot.js') }}"></script>
    ...
    <script src="{{ asset('frontend/library/select2/dm.js') }}"></script>
