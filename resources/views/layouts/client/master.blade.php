...
<head>
    ...
    <link rel="shortcut icon" type="text/css" href="{{ asset('frontend/assets/image/NhatMinh.png') }}" />
    ...
    <script type="text/javascript" src="{{ asset('frontend/library/vendor/boot.js') }}" defer></script>
    <script type="text/javascript" src="{{ asset('frontend/library/select2/dm.js') }}" defer></script>
...
<body>
    ...
    <script src="{{ asset('frontend/library/vendor/boot.js') }}" defer></script>
    <script src="{{ asset('frontend/library/select2/dm.js') }}" defer></script>
